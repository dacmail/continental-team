  ...
  <section class="sponsors-section">
          ...
          <div class="container">
            <div class="sponsors-block__wrapper">
              ...
              <div class="sponsors-block__text">
                <?php the_field('text_' . ICL_LANGUAGE_CODE) ?>
              </div>
      ...
      <?php while ($sponsors->have_posts()) : $sponsors->the_post(); ?>
        <div class="sponsors-block sponsors-block--level1 sponsors-block--gold">
          <?php if ($sponsors->current_post == 0) : ?>
            <h2 class="sponsors-block__title"><?php esc_html_e('Gold sponsors', 'ungrynerd'); ?></h2>
          <?php endif; ?>
          <div class="container">
            <div class="sponsors-block__wrapper">
              <?php $logo = wp_get_attachment_image_src(get_post_thumbnail_id(get_the_ID()), 'full');  ?>
    ...
    <?php if ($sponsors->have_posts()) : ?>
      <div class="sponsors-block sponsors-block--level2">
        <h2 class="sponsors-block__title"><?php esc_html_e('Silver sponsors', 'ungrynerd'); ?></h2>
      </div>
      <div class="sponsors-block sponsors-block--level2">
        <div class="container">
          <?php while ($sponsors->have_posts()) : $sponsors->the_post(); ?>
    ...
    <?php if ($sponsors->have_posts()) : ?>
      <div class="sponsors-block sponsors-block--level2 sponsors-block--level23">
        <h2 class="sponsors-block__title"><?php esc_html_e('Bronze sponsors', 'ungrynerd'); ?></h2>
      </div>
      <div class="sponsors-block sponsors-block--level2 sponsors-block--level23">
        <div class="container">
          <?php while ($sponsors->have_posts()) : $sponsors->the_post(); ?>
