...
<?php wp_nonce_field('animate_new_slider_action','animate_new_slider_nonce_field'); ?>	
	<div class="postbox-container" style="width:100%">
		<div class="meta-box-sortables ui-sortable" style="margin:0">
			<div class="postbox">
			<h3 class="hndle"><span><?php _e('New Grid and Carousel','ssocial');?></span></h3>
			<div class="inside">
			<table class="anew_slider">
				<tr>
					<th><strong class="afl"><?php _e('Grid and Carousel Title','ssocial');?> :</strong></th>
				...
				<p class="description"><?php _e('The title of the Grid and Carousel. Example: Grid','ssocial');?></p></td>
				</tr>
			</table>
